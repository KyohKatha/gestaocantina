...
import Pkg2FindScience.Booktitle;
...
public class Calendar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        b.setStartDate(request.getParameter("sDate"));
        b.setEndDate(request.getParameter("eDate"));
        request.getSession().setAttribute("selectedEvent", b);

        request.getSession().setAttribute("edit", b.getCod());
